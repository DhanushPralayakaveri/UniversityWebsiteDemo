...
<body>
    ...
    <section class="probootstrap-section">
        <div class="container">
            <div class="row">
                <?php
                $result = $conn->query("SELECT name, subject, image FROM teachers_info");
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <img src="data:image/jpeg;base64,<?php echo $teacherImage; ?>" alt="<?php echo $teacherName; ?>"></figure>
                    <div class="text">
                            <h3><?php echo $teacherName; ?></h3>
                            <p><?php echo $teacherSubject; ?></p>
